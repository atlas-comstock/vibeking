    ...
    .values([
      {
        ...
        siteUrl: "https://cream-portfolio.vibeking.dev/",
        title: "奶油色作品集",
        description: "小红书风平台发布示例",
        coverEmoji: "🧁",
        tags: ["设计", "平台"],
        source: "hosted",
        likeCount: 12,
      ...
      },
      {
        ...
        siteUrl: "https://red-note-landing.vibeking.dev/",
        title: "Red-note style landing",
        description: "Cute cream palette landing page on platform",
        coverEmoji: "📕",
